...
public class DashboardTest {
    ...
    public void shouldHaveCharts(FxRobot robot) {
        ...
        assertThat(robot.lookup("#barChart").queryAs(BarChart.class).getTitle(), equalTo("Comparaison des dépenses et revenus"));
    }

    @Test
    public void shouldHaveAxis(FxRobot robot) {
        verifyThat("#xAxis", isVisible());
        verifyThat("#yAxis", isVisible());
    }

    @Test
    public void shouldHaveData(FxRobot robot) {
        verifyThat("#pieChart", isVisible());
        verifyThat("#lineChart", isVisible());
        verifyThat("#barChart", isVisible());
    }
